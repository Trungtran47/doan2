            ...
            if($getLastestA){
              while($resultA = $getLastestA->fetch_assoc()){
			     ...
			     ?>
                        ...
                        <a  href="preview.php?proid=<?php echo $resultA['productId'] ?>"><img class="card-img-top" style=" height:100px" src="admin/uploads/<?php echo $resultA['image'] ?>" alt=""></a>
                <div class="card-body">
            ...
            if($getLastestAu){
              while($resultAu = $getLastestAu->fetch_assoc()){
			     ...
			     ?>
                        <div class="col-3 ">
                        <div class="card  " style="width: 11rem; margin-bottom: 30px;">
                        <a  href="preview.php?proid=<?php echo $resultAu['productId'] ?>"><img class="card-img-top" style=" height:100px" src="admin/uploads/<?php echo $resultAu['image'] ?>" alt=""></a>
                <div class="card-body">
            ...
            if($getLastestHaisan){
              while($resultHaisan = $getLastestHaisan->fetch_assoc()){
			     ...
			     ?>
                        <div class="col-3 ">
                        <div class="card  " style="width: 11rem; margin-bottom: 30px;">
                        <a  href="preview.php?proid=<?php echo $resultHaisan['productId'] ?>"><img class="card-img-top" style=" height:100px" src="admin/uploads/<?php echo $resultHaisan['image'] ?>" alt=""></a>
                <div class="card-body">
            ...
            if($getLastestDouong){
              while($resultDouong = $getLastestDouong->fetch_assoc()){
			     ...
			     ?>
                        <div class="col-3 ">
                        <div class="card  " style="width: 11rem; margin-bottom: 30px;">
                        <a  href="preview.php?proid=<?php echo $resultDouong['productId'] ?>"><img class="card-img-top" style=" height:100px" src="admin/uploads/<?php echo $resultDouong['image'] ?>" alt=""></a>
                <div class="card-body">
            ...
            if($getLastestDouongcon){
              while($resultDouongcon = $getLastestDouongcon->fetch_assoc()){
			     ...
			     ?>
                        <div class="col-3 ">
                        <div class="card  " style="width: 11rem; margin-bottom: 30px;">
                        <a  href="preview.php?proid=<?php echo $resultDouongcon['productId'] ?>"><img class="card-img-top" style=" height:100px" src="admin/uploads/<?php echo $resultDouongcon['image'] ?>" alt=""></a>
                <div class="card-body">
